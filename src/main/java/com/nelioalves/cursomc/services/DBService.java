...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "cursospringionicbds@gmail.com", "36378912377",
				TipoCliente.PESSSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "matheusb565@gmail.com", "25456646005", TipoCliente.PESSSOAFISICA,
				pe.encode("123"));
